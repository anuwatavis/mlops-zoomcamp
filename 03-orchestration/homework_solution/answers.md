...
```plantext
# answer
21:39:58.730 | INFO    | Task run 'train_model-7c866860-0' - Finished in state Completed()
21:39:58.763 | INFO    | Flow run 'fortunate-okapi' - Created task run 'run_model-6559300c-0' for task 'run_model'
Run model
The MSE of validation is: 11.63703043494642
```
...
```plantext
-rw-r--r--  13K Jun  6 22:17 dv-2021-08-15.bin
```
...
┡━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━╇━━━━━━━━━━━━━━━━━━━┩
│ e6e7a482-3b83-4056-b096-32d0f2a26d0f │ global │ None              │
└──────────────────────────────────────┴────────┴───────────────────┘
```
